...
# --- 設定項目 ---
PROBLEMS_FILE = 'problems_integration.json'
OUTPUT_FILENAME_BASE = '積分問題解答一覧'
...
"""
    ...
    for p in problems:
        ...
        # ★★★ 修正点: 問題文を積分用に修正 ★★★
        # 積分問題は数式自体が問題文となるため、「〜を計算せよ」等の文言は省略
