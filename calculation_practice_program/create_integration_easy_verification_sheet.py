...
PROBLEMS_FILE = 'problems_integration_easy.json'
OUTPUT_FILENAME_BASE = '積分問題（基礎）解答一覧'
...
def generate_verification_latex(problems):
    """積分問題（基礎）の一覧表を生成するLaTeXソースを作成する"""
...
\begin{document}
\begin{center}
\large{\textbf{数学III 積分問題（基礎）解答一覧}}
\end{center}
\vspace{5mm}
% 表のヘッダーを一度だけ表示
